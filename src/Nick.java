...
public class Nick{
	...
	/**
	 * @return singleton instance of Nick
	 */
	...
	static final long DIE_RATE = 500;
	...
	Date dTime;				//date representation of time so we can have it show in minutes:seconds.milliseconds
	...
	/**
	 * @return time formated for display
	 */
	...
	/**
	 * @return a decimal formatted representation of the score
	 */

...
public class SFont {
	...
	{
		try {
			f = Font.createFont(Font.TRUETYPE_FONT, (GameEngine.isRscLoading())?getClass().getResourceAsStream("data/font/"+fontName+".ttf"):new FileInputStream(new File("data/font/"+fontName+".ttf"))).deriveFont(size);

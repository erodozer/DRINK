...
public class SWindow {
	...
	/**
	 * Global window graphic used when drawing the in-game GUI
	 */
	private static Sprite image;
	
	/**
	 * Sets the window graphic to use
	 * @param s preloaded window sprite
	 *  for this to work, it is required that the window sprite have 3 xFrames and 3 yFrames
	 */
	public static void setWindowImage(Sprite s)
	{
		image = s;
	}
	 ...
	 * leave as null if you don't want it to fill
	 */
	Color bg;
	/**
	 * Additive hue change of the window
	 */
	Color hue;
	
	/**
	 * Final image buffer generated for the window
	 */
	Image window;
	...
	/**
	 * window border offset for fill color
	 */
	int fillOffset = 5;
	...
	/**
	 * Sets the additive hue of the window
	 * @param c hue color
	 */
